...
package com.xuebinduan.zxing.result.supplement;
...
import com.xuebinduan.zxing.HttpHelper;
...
final class BookResultInfoRetriever extends SupplementalInfoRetriever {
  ...
  void retrieveSupplementalInfo() throws IOException {
    ...
    CharSequence contents = com.xuebinduan.zxing.HttpHelper.downloadViaHttp("https://www.googleapis.com/books/v1/volumes?q=isbn:" + isbn,
                                                       com.xuebinduan.zxing.HttpHelper.ContentType.JSON);
    ...
    String baseBookUri = "http://www.google." + com.xuebinduan.zxing.LocaleManager.getBookSearchCountryTLD(context)
