...
final class ProductResultInfoRetriever extends SupplementalInfoRetriever {
  ...
  void retrieveSupplementalInfo() throws IOException {
    ...
    String uri = "https://www.google." + com.xuebinduan.zxing.LocaleManager.getProductSearchCountryTLD(context)
            + "/m/products?ie=utf8&oe=utf8&scoring=p&source=zxing&q=" + encodedProductID;
    CharSequence content = com.xuebinduan.zxing.HttpHelper.downloadViaHttp(uri, com.xuebinduan.zxing.HttpHelper.ContentType.HTML);
