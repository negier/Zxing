...
package com.xuebinduan.zxing.history;
...
import com.xuebinduan.zxing.CaptureActivity;
...
public final class HistoryActivity extends ListActivity {
  ...
  protected void onListItemClick(ListView l, View v, int position, long id) {
    if (adapter.getItem(position).getResult() != null) {
      Intent intent = new Intent(this, com.xuebinduan.zxing.CaptureActivity.class);
      intent.putExtra(com.xuebinduan.zxing.Intents.History.ITEM_NUMBER, position);
    ...
    switch (item.getItemId()) {
      case R.id.menu_history_send:
        ...
        if (historyFile == null) {
          ...
          intent.addFlags(com.xuebinduan.zxing.Intents.FLAG_NEW_DOC);
