...
package com.xuebinduan.zxing.book;
...
public final class SearchBookContentsActivity extends Activity {
  ...
  public void onCreate(Bundle icicle) {
    ...
    if (com.xuebinduan.zxing.LocaleManager.isBookSearchUrl(isbn)) {
  ...
  private final class NetworkTask extends AsyncTask<String,Object,JSONObject> {
    ...
    protected JSONObject doInBackground(String... args) {
      try {
        ...
        String uri;
        if (com.xuebinduan.zxing.LocaleManager.isBookSearchUrl(theIsbn)) {
        ...
        CharSequence content = com.xuebinduan.zxing.HttpHelper.downloadViaHttp(uri, com.xuebinduan.zxing.HttpHelper.ContentType.JSON);
