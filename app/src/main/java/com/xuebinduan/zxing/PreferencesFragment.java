 ...
 *
 * @see com.xuebinduan.zxing.PreferencesActivity
 */
public final class PreferencesFragment 
  ...
  public void onCreate(Bundle icicle) {
    ...
    checkBoxPrefs = findDecodePrefs(preferences,
                                    com.xuebinduan.zxing.PreferencesActivity.KEY_DECODE_1D_PRODUCT,
                                    com.xuebinduan.zxing.PreferencesActivity.KEY_DECODE_1D_INDUSTRIAL,
                                    com.xuebinduan.zxing.PreferencesActivity.KEY_DECODE_QR,
                                    com.xuebinduan.zxing.PreferencesActivity.KEY_DECODE_DATA_MATRIX,
                                    com.xuebinduan.zxing.PreferencesActivity.KEY_DECODE_AZTEC,
                                    com.xuebinduan.zxing.PreferencesActivity.KEY_DECODE_PDF417);
    disableLastCheckedPref();

    EditTextPreference customProductSearch = (EditTextPreference)
        preferences.findPreference(com.xuebinduan.zxing.PreferencesActivity.KEY_CUSTOM_PRODUCT_SEARCH);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
      if (!isValid(newValue)) {
        AlertDialog.Builder builder =
            new AlertDialog.Builder(com.xuebinduan.zxing.PreferencesFragment.this.getActivity());
