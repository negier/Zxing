...
package com.xuebinduan.zxing.share;
...
public final class ShareActivity extends Activity {
  ...
  private void launchSearch(String text) {
    Intent intent = buildEncodeIntent(com.xuebinduan.zxing.Contents.Type.TEXT);
  ...
  private void showContactAsBarcode(Uri contactUri) {
    ...
    if (hasPhone) {
      try (Cursor phonesCursor = resolver.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI,
        ...
        if (phonesCursor != null) {
          ...
          while (phonesCursor.moveToNext() && foundPhone < com.xuebinduan.zxing.Contents.PHONE_KEYS.length) {
            String number = phonesCursor.getString(phonesNumberColumn);
            if (number != null && !number.isEmpty()) {
              bundle.putString(com.xuebinduan.zxing.Contents.PHONE_KEYS[foundPhone], massageContactData(number));
            }
            int type = phonesCursor.getInt(phoneTypeColumn);
            bundle.putInt(com.xuebinduan.zxing.Contents.PHONE_TYPE_KEYS[foundPhone], type);
            foundPhone++;
          }
        }
      }
    ...
    try (Cursor emailCursor = resolver.query(ContactsContract.CommonDataKinds.Email.CONTENT_URI,
      ...
      if (emailCursor != null) {
        ...
        while (emailCursor.moveToNext() && foundEmail < com.xuebinduan.zxing.Contents.EMAIL_KEYS.length) {
          String email = emailCursor.getString(emailColumn);
          if (email != null && !email.isEmpty()) {
            bundle.putString(com.xuebinduan.zxing.Contents.EMAIL_KEYS[foundEmail], massageContactData(email));
          }
          foundEmail++;
        }
      }
    ...
    Intent intent = buildEncodeIntent(com.xuebinduan.zxing.Contents.Type.CONTACT);
  ...
  private static Intent buildEncodeIntent(String type) {
    ...
    intent.setPackage("com.xuebinduan.zxing");
    intent.addFlags(Intents.FLAG_NEW_DOC);
